// Defining the global upgrade function
...
function Upgrade() {
    return (
        <div className='flex flex-col min-h-[calc(100vh-165px)] p-10'>
            ...
            <h2 className='text-center text-gray-500 dark:text-gray-300'>Upgrade to Pro to unlock unlimited access to all AI tools and premium features!</h2>
